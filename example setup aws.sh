...
echo "Sign up for an AWS Account at aws.amazon.com. Use the `IAM` tool to create a user, and create an access key. Download the access key and use it when prompted in the next step:"
...
# source: http://www.stormacq.com/?p=534, BSD 3 License
...
# create key pair if it doesn't exist? this isn't very easy
